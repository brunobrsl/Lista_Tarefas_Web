			...
			<div class="row">
				<div class="col-sm-3 menu">
					<ul class="list-group">
						...
						<li class="list-group-item active" style="border-color: #003F7F;"><a class="font-weight-bold" style="color: #003F7F;" href="#">Todas as Tarefas</a></li>
					</ul>
				</div>
				...
				<div class="col-sm-9">
					<div class="container pagina">
						<div class="row">
							<div class="col">
								<h3 style="color: #003F7F;">Todas as Tarefas</h3>
								<hr />
								...
								<? } else { ?>
									<div>
										<h4 class="text-center">Não há nenhuma tarefa</h4>
									</div>
								<? } ?>
							</div>
						</div>
